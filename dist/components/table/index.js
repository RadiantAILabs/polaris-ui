...
export { Root, Header, HeaderCell, Body, BodyRow, BodyCell, 
//
Root as TableRoot, Header as TableHeader, HeaderCell as TableHeaderCell, Body as TableBody, BodyRow as TableBodyRow, BodyCell as TableBodyCell };
export default Root;
